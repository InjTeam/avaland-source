...
class Support(Module):
    ...
    def get_social_channels(self, msg, client):
        channels = []
        channels.append({"act": True, "prt": 1, "id": 1, "stid": "AVALAND",
                         "dsctn": f"Подпишись на нас:\n"
                         f"https://vk.com/avalandofficial",
                         "ttl": "AVALAND", "icnurl": icon,
                         "lnk": "https://vk.com/avalandofficial"})
